...
\node[canvas is zy plane at x=0] (input) at (-2,0,0) {\includegraphics[width=3cm,height=8cm]{../inputpic/plant03_day01.png}};
...
\draw [connection]  (end_b9-east)    -- node {\midarrow} (out_layer-west);
